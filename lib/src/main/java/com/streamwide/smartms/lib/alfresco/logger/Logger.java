...
public class Logger {
    ...
    public interface LoggerDelegate {
        ...
        void warn(@Nullable String tag, @NonNull String message);
    }
    ...
    public static void warn(@Nullable String tag, @NonNull String message)
    {
        if (SingletonHolder.getInstance().mLogLevel.compareTo(LogLevel.WARNING) <= 0) {
            SingletonHolder.getInstance().mDelegate.warn(tag, message);
        }
    }
}
